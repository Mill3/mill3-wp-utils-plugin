...
class Live_Site_Viewer extends Mill3_Wp_Utils_Component
{
    protected function init(): void {
        $this->loader->add_action('wp_enqueue_scripts', $this, 'inject_communication', 100);
    }

    //
    // inject our bridge communication system only when url param is specified
    //
    public function inject_communication() {
        ...
        $js = ob_get_clean();
        wp_add_inline_script('mill3wp/js', $js, 'after');
    }

    // getters
    public static function id() : string { return 'live-site-viewer'; }
    public function version() : string { return '0.0.1'; }
    public function title() : string { return __('Live Site Viewer', 'mill3-wp-utils'); }
